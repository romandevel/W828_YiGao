 ...
 */
#define UNIFI_SOFT_TRAFFIC_Q_LENGTH /* jmm (20+1) */  (4+1)
#define UNIFI_SOFT_COMMAND_Q_LENGTH /* jmm (8+1)  */  (2+1)

#include "csr_types.h"          /* from the os porting folder */
#include "csr_util.h"
 ...
 * @ingroup upperedge
 */
CsrInt32 unifi_send_signal(card_t *card, CsrUint8 *sigptr,
                           CsrUint32 siglen,
 ...
 * @ingroup upperedge
 */
void* unifi_fw_read_start(void *ospriv, CsrInt8 is_fw, card_info_t *info);

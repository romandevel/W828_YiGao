...
extern int unsolicited_parse(struct gsmd *g, const char *buf, int len, const char *param);
...
extern int unsolicited_register_array(const struct gsmd_unsolicit *arr, int len);

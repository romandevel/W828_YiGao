...
int sms_pdu_to_msg(struct gsmd_sms_list *dst, const u_int8_t *src, int pdulen, int len, int ds);
...
int sms_pdu_decode_dcs(struct gsmd_sms_datacodingscheme *dcs, const u_int8_t *data);

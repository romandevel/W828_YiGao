...
{
	//显示名称				//执行函数
	{"业务操作",			Op_OperationSelect_Desk},
	{"记录查询",			Rec_SearchDesk},
	//{"删除错扫",			Rec_DelErrScanDesk},
	{"资料下载",			Op_DownLoadSelect_Desk},
	//{"快件查询",			Express_InquireDesk},
	//{"派送区域查询",		Delivery_InquireArea},
...
S32 MainDesk_ButtonEnter(void *pView, U16 state)
{
	...
	case BUTTON_ID_1://ESC
		if(DLG_CONFIRM_EN == Com_SpcDlgDeskbox("确认返回登录界面?",0,pDesk,3,NULL,NULL,3000))
		{
			return RETURN_QUIT;
		}
		break;

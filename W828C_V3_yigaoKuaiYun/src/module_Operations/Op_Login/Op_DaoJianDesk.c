...
{
	//显示名称				//执行函数
	{"到件操作",			Operation_YGDaoJian_Desk},
	{"到件称重",			Operation_YGDaoJianWT_Desk},
	{"到件退件",			Operation_YGTuiJian_DaoJian_Desk},
	{"回单到件",			Operation_YGHuiDan_DaoJian_Desk},
};

...
const tGrapViewAttr PaiJianWT_ViewAttr[] =
{
	...
	{EDIT_ID_3,	   55, 85,172,22,   55,85,227,107, 0,0,0xffff,0,1,1,1,0},//运单号 21
...
int Operation_PaiJianWT_Desk(void *pDeskFather)
{
	...
	pDesk = Grap_CreateDeskbox((tGrapViewAttr*)&PaiJianWT_ViewAttr[idx++], "派件称重");
...
/*-----------------------------------------记录查询显示------------------------------------------------*/
const U8* const opType_PaiJianWT[]=//收件
{
	"状态:",

...
const tGrapViewAttr FaJianWT_ViewAttr[] =
{
	...
	{EDIT_ID_2,   	   55, 85,83, 22,   55,85,138,107, 0,0,0xCE59,0,1,0,1,0},//重量
...
int Operation_FaJianWT_Desk(void *pDeskFather)
{
	...
	pDesk = Grap_CreateDeskbox((tGrapViewAttr*)&FaJianWT_ViewAttr[idx++], "发件称重");
...
/*-----------------------------------------记录查询显示------------------------------------------------*/
const U8* const opType_FaJianWT[]=//发件
{
	"状态:",
